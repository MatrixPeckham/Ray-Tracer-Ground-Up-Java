...
//        int numSamples = 16;  	// for Figure 17.8(a)
	int numSamples = 256;	// for Figure 17.8(b)
...
//        w.setAmbient(ambientPtr);					// for Figure 17.8(a)
	...
	w.setAmbient(occluderPtr);				// for Figure 17.8(b)
	...
	// sphere
        ...
        Sphere spherePtr = new Sphere(new Point3D(0, 1, 0), 1);
