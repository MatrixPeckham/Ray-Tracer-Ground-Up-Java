 ...
 */
public class BuildFigure24A implements BuildWorldFunction {
...
// This builds the scene for Figure 27.24(a)
        ...
        pinholePtr.setLookat(0, 4, 0);
        pinholePtr.setViewDistance(1800);
        ...
        Instance ellipsoidPtr = new Instance(new Sphere(new Point3D(0.0), 1.0));
        ellipsoidPtr.setMaterial(glassPtr);
