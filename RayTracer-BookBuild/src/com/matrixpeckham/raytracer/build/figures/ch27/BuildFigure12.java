...
// This builds the scene for Figure 27.12
        ...
        // camera w.setup for the top down view, Figure 7.2 with maxDepth = 5 and eta = 1.5
        pinholePtr.setEye(2.0, 50.0, -3.0);
        pinholePtr.setLookat(2.0, 0.0, -3.0);
        ...
        Sphere spherePtr1 = new Sphere(new Point3D(0, 4.5, 0), 3);
