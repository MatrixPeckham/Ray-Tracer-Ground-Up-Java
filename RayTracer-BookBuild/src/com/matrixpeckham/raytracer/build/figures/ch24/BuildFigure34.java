 ...
 */
public class BuildFigure34 implements BuildWorldFunction {
...
// panoramic is declared in LightProbe.h, which is #included in World.h
	...
	reflectivePtrc.setCd(new RGBColor(0));
	reflectivePtrc.setKr(kr);
	reflectivePtrc.setCr(0.65, 0.75, 1.0);   // pale blue
		
	Sphere spherePtr1 = new Sphere(new Point3D(0.0), radius);
	spherePtr1.setShadows(false);
	spherePtr1.setMaterial(reflectivePtrc);
	spheres.addObject(spherePtr1);
	...
	reflectivePtr0.setCd(new RGBColor(0));
	reflectivePtr0.setKr(kr);
	reflectivePtr0.setCr(0.5, 1.0, 0.5);  // light green
	...
	reflectivePtr1.setCr(0.4, 1.0, 1.0);  // cyan
	...
	reflectivePtr2.setCd(new RGBColor(0));
	reflectivePtr2.setKr(kr);
	reflectivePtr2.setCr(1.0, 1.0, 0.4);  // lemon
	...
	reflectivePtr3.setCd(new RGBColor(0));
	reflectivePtr3.setKr(kr);
	reflectivePtr3.setCr(1.0, 0.5, 1.0);  // mauve
	...
	reflectivePtr4.setCd(new RGBColor(0));
	reflectivePtr4.setKr(kr);
	reflectivePtr4.setCr(1.0, 0.75, 0.25);  // orange
	...
	reflectivePtr5.setCd(new RGBColor(0));
	reflectivePtr5.setKr(kr);
	reflectivePtr5.setCr(0.5, 0.5, 1.0);  // blue
	...
	for (int j = 0; j < numSpheres; j++) {
		...
		Sphere spherePtr = new Sphere(center, radius);
		spherePtr.setMaterial(materials.get(j));
