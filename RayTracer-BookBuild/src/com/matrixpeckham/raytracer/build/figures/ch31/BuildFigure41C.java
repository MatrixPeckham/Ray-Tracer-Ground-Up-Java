 ...
 */
public class BuildFigure41C implements BuildWorldFunction {
...
// different, as are the box, the lighting, and the viewing.
        ...
        try {
            imagePtr.loadPPMFile(Thread.currentThread().getContextClassLoader().getResourceAsStream(path + "turquoise_ramp.ppm"));
