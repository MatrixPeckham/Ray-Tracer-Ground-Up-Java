 ...
 */
public class BuildFigure06CD implements BuildWorldFunction {
...
// This builds the scenes for Figures 30.6(c) and (d)
	...
	// turbulence texture
        ...
        // texture
        TurbulenceTexture turbulenceTexturePtr = new TurbulenceTexture(noisePtr);
        turbulenceTexturePtr.setColor(1.0, 0.5, 0.0);  // orange
        turbulenceTexturePtr.setMinValue(0.0);
        turbulenceTexturePtr.setMaxValue(1.2);

        double s = 0.05;      	// uniform scaling factor
        double xs = 10.0;		// non-uniform scaling factor in x direction
        TInstance scaledTexturePtr = new TInstance(turbulenceTexturePtr);
