 ...
 */
public class BuildFigure05B implements BuildWorldFunction{
	...
	Instance ellipsoidPtr = new Instance(new Sphere());
	ellipsoidPtr.setMaterial(phongPtr);
	ellipsoidPtr.scale(2, 3, 1);
	ellipsoidPtr.rotateX(-45);
	ellipsoidPtr.translate(0, 1, 0);
