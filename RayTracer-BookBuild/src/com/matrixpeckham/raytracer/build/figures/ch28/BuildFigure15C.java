 ...
 */
public class BuildFigure15C implements BuildWorldFunction {
...
// Note that etaOut and cfOut are different from their values in Figures 28.15 (a) and (b).
        int numSamples = 25;
...
//	w.addObject(spherePtr1);
        ...
        diamondPtr.setIorOut(1.0);			// air
        diamondPtr.setCfIn(diamondColor);
        diamondPtr.setCfOut(Utility.WHITE);
