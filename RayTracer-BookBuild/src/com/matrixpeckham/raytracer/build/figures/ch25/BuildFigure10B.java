...
// This builds the scene for Figure 25.10(b).
	...
	double exp = 25000.0;
	GlossyReflector glossyReflectorPtr = new GlossyReflector();
	glossyReflectorPtr.setSamples(numSamples, exp);			
	glossyReflectorPtr.setKa(0.0); 
	glossyReflectorPtr.setKd(0.0);
	glossyReflectorPtr.setKs(0.0);
	glossyReflectorPtr.setExp(exp);
	glossyReflectorPtr.setCd(Utility.BLACK);
	glossyReflectorPtr.setKr(0.9);
	glossyReflectorPtr.setExponent(exp);
	glossyReflectorPtr.setCr(0.9, 1.0, 0.9);  // light green
...
//	rectanglePtr1.setMaterial(reflectivePtr2);
	rectanglePtr1.setMaterial(glossyReflectorPtr); 
...
//	rectanglePtr2.setMaterial(reflectivePtr2); 
	rectanglePtr2.setMaterial(glossyReflectorPtr); 
