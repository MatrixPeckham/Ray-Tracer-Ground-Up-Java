 ...
 */
public class BuildFigure18C implements BuildWorldFunction {
...
int numSamples = 25;
	...
	Instance scaledGridPtr = new Instance(gridPtr);
	scaledGridPtr.scale(1, 0.25, 1);
	w.addObject(scaledGridPtr);
