...
// Try it initially with maxDepth = 3 and one sample per pixel.
	...
	pinholePtr.setViewDistance(750.0);	
	...
	for (int j = 0; j < numBoxes; j++) {
		...
		Point3D p1=new Point3D(xMin + j * (thickness + gap) + thickness, height, 0.0);
