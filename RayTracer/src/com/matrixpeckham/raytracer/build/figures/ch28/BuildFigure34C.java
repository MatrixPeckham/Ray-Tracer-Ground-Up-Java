 ...
 */
public class BuildFigure34C implements BuildWorldFunction{
...
// This builds the scene for Figure 28.34(c)
	...
	pinholePtr.setEye(0, 0, 2);      
	pinholePtr.setLookat(10, 0, 2);    
	pinholePtr.setViewDistance(100.0);
	...
	for (int j = 0; j < numSpheres; j++) {
		...
		ConvexPartSphere topHalfPtr = new ConvexPartSphere(center, sphereRadius, 0, 360, 0, 90);
		topHalfPtr.setMaterial(phongPtr1);
		w.addObject(topHalfPtr);
		
		ConvexPartSphere bottomHalfPtr = new ConvexPartSphere(center, sphereRadius, 0, 360, 90, 180);
	...
	checker3DPtr.setSize(4.2); 
	checker3DPtr.setColor1(Utility.WHITE);    	
	checker3DPtr.setColor2(0.5);
