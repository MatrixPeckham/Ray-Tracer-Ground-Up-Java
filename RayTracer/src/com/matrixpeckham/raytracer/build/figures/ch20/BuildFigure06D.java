 ...
 */
public class BuildFigure06D implements BuildWorldFunction{
	...
	checkerPtr.setNumHorizontalCheckers(45);
	checkerPtr.setVerticleLineWidth(0.1);
	checkerPtr.setHorizontalLineWidth(0.1);
