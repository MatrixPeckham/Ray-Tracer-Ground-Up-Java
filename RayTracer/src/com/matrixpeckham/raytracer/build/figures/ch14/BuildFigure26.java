...
// This builds the scene for Figure 14.24
	...
	Sphere spherePtr1 = new Sphere(new Point3D(-3.0 * radius - 1.5 * gap, 0.0, 0.0), radius);
	...
	Sphere spherePtr2 = new Sphere(new Point3D(-radius - 0.5 * gap, 0.0, 0.0), radius);
	...
	Sphere spherePtr3 = new Sphere(new Point3D(radius + 0.5 * gap, 0.0, 0.0), radius);
	...
	Sphere spherePtr4 = new Sphere(new Point3D(3.0 * radius + 1.5 * gap, 0.0, 0.0), radius);
