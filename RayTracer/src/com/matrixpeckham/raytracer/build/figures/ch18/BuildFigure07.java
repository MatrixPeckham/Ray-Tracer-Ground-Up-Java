...
public class BuildFigure07 implements BuildWorldFunction{
	...
	//w.setAmbient(ambientPtr);				// for Figure 18.7(b)
	...
	w.setAmbient(ambientOccluderPtr);	// for Figure 18.7 (a) & (c)
	...
	emissivePtr.setCe(Utility.WHITE);   			// Utility.WHITE
	...
	w.addLight(environmentLightPtr);			// for Figure 18.7 (b) & (c)
