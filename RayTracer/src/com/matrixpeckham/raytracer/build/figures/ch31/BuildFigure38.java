...
// There is no ground plane.
	...
	TInstance sandstonePtr1 = new TInstance(new RampFBmTexture(imagePtr1, numOctaves, fbmAmount));
	...
	Instance cylinderPtr1 = new Instance(new SolidCylinder(bottom, top, radius)); 
	...
	TInstance sandstonePtr2 = new TInstance(new RampFBmTexture(imagePtr2, numOctaves, fbmAmount));
	...
	Instance cylinderPtr2 = new Instance(new SolidCylinder(bottom, top, radius)); 
	...
	TInstance sandstonePtr3 = new TInstance(new RampFBmTexture(imagePtr3, numOctaves, fbmAmount));
	...
	Instance cylinderPtr3 = new Instance(new SolidCylinder(bottom, top, radius)); 
	...
	TInstance sandstonePtr4 = new TInstance(new RampFBmTexture(imagePtr4, numOctaves, fbmAmount));
	...
	Instance cylinderPtr4 = new Instance(new SolidCylinder(bottom, top, radius)); 
