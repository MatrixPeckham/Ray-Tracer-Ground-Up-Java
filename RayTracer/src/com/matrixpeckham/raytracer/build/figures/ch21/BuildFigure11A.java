 ...
 */
public class BuildFigure11A implements BuildWorldFunction{
	...
	Rosette rosettePtr = new Rosette(numRings, holeRadius, ringWidth, rb, y0, y1);
	...
	Image imagePtr1 = new Image();						
        String filename = "C:\\Users\\Owner\\Documents\\Ground Up raytracer\\Textures\\ppm\\BlueMarbleRamp.ppm";
        try {
	...
	for (int j = 0; j < numObjects; j++) {
		...
		wedgeMarblePtr.scale(new Vector3D(0.25));
		...
		wedgeMarblePtr.translate(10.0 * (2.0 * Utility.randDouble() - 1.0), 20.0 * (2.0 * Utility.randDouble() - 1.0), 30.0 * (2.0 * Utility.randDouble() - 1.0));
