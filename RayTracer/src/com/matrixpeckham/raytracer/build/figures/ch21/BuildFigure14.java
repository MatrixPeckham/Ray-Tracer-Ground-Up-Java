...
public class BuildFigure14 implements BuildWorldFunction {
    ...
    public void build(World w) {
        ...
        Ring bottomPtr = new Ring(new Point3D(0, y0, 0), new Normal(0, -1, 0),
                innerRadius, outerRadius);
        bottomPtr.setMaterial(mattePtr1);

        Ring topPtr = new Ring(new Point3D(0, y1, 0), new Normal(0, 1, 0),
                innerRadius, outerRadius);
    ...
    private static final Logger LOG
            = Logger.getLogger(BuildFigure14.class.getName());
