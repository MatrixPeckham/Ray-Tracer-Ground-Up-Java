 ...
 */
public class BuildFigure09_11 implements BuildWorldFunction {
...
/*        ConvexPartCylinder cylinderPtr = new ConvexPartCylinder(bottom,
                top,
                radius,
                phiMin,
                phiMax);
        ...
        PartCylinder cylinderPtr = new PartCylinder(bottom,
                ...
                phiMax);
        cylinderPtr.setMaterial(mattePtr1);
        w.addObject(cylinderPtr);// for 17.11 */
