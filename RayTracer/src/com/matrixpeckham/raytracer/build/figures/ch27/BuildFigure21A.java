 ...
 */
public class BuildFigure21A implements BuildWorldFunction {
...
// This builds the scene for Figure 27.21(a)
	...
	Disk diskPtr1 = new Disk(new Point3D(0, 4.5, 0),new Normal(0, 0, 1), 3);
	diskPtr1.setMaterial(glassPtr);
	w.addObject(diskPtr1);
	
	Disk diskPtr2 = new Disk(new Point3D(0, 4.5, -3),new Normal(0, 0, -1), 2);
	diskPtr2.setMaterial(glassPtr);
	w.addObject(diskPtr2);
