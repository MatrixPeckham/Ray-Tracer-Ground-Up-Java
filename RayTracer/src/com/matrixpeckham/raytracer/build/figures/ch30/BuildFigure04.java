...
// The Chapter 30 download has a version of w scene where the checkers rendered with colored outlines. 
	...
	sphereCheckerPtr.setHorizontalLineWidth(0.0);
	sphereCheckerPtr.setVerticalLineWidth(0.0);
	...
	cylinderCheckerPtr.setHorizontalLineWidth(0.0);
	cylinderCheckerPtr.setVerticalLineWidth(0.0);
	...
	coneCheckerPtr.setHorizontalLineWidth(0.0);
	coneCheckerPtr.setVerticleLineWidth(0.0);
	...
	rectangleCheckerPtr1.setXLineWidth(0.0);
	rectangleCheckerPtr1.setZLineWidth(0.0);
	...
	rectangleCheckerPtr2.setXLineWidth(0.0);
	rectangleCheckerPtr2.setZLineWidth(0.0);
	...
	rectangleCheckerPtr3.setXLineWidth(0.0);
	rectangleCheckerPtr3.setZLineWidth(0.0);
