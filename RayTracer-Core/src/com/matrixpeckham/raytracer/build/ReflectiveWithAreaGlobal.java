 ...
 */
public class ReflectiveWithAreaGlobal implements BuildWorldFunction {
    ...
    public void build(World w) {
        ...
        svMattePtr.setSampler(new MultiJittered(numSamples));
