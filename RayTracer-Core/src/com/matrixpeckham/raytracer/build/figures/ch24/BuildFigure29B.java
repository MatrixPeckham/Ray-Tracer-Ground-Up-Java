...
// panoramic is declared in LightProbe.h, which is #included in World.h
	...
	Point3D p0=new Point3D(-100.0);
	Point3D p1=new Point3D(100.0);
	
	Box boxPtr = new Box(p0, p1);	
	boxPtr.setMaterial(reflectivePtr);

	Instance rotatedBoxPtr = new Instance(boxPtr);
	rotatedBoxPtr.rotateY(-20);
	rotatedBoxPtr.rotateX(39);
	w.addObject(rotatedBoxPtr);
	...
	Image imagePtr = new Image();
        ...
        try {
            ...
            Logger.getLogger(BuildFigure29B.class.getName()).
